...
<head>
	...
	<?php	
        ...
        // jquery modal osx
        Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/css/modalosx/css/osx.css', 'screen, projection');
        Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/css/modalosx/js/jquery.simplemodal.js');
        Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/css/modalosx/js/osx.js', 0);
	?>
...
<div id="footer">
    <div id="footer_container">
       Copyright 2013 Asep Rahmat Ginanjar
    </div>
</div>    
